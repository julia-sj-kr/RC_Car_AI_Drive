...
>> 주요 구성 요소 및 구조  
>>- TensorFlow는 `텐서(tensor)`를 중심으로 한 데이터 처리 및 계산을 수행하며, 다차원 배열을 사용해 수학적 연산을 간결하게 처리할 수 있습니다.
>>- ㅁ
>>- ㅊ
>>- ㅌ
>>- 
>>- Tensor 출력 예시: <tf.Tensor: shape=(), dtype=int32, numpy=8>
>>- 이 텐서는 스칼라 값 8을 담고 있으며, 정수형 데이터 타입(int32)으로 저장된 0차원 텐서입니다. 쉽게 말해, 이 텐서는 단순히 8이라는 값 하나를 담고 있는 정수형 텐서라고 이해할 수 있습니다.
