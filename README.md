...
<div align="center">
  <img src="https://github.com/user-attachments/assets/9221b344-2129-493c-9d48-f0adcaa03fc0" width="700">
</div>

<div align="center">
  <img src="https://github.com/user-attachments/assets/07a2ba4d-e853-4e15-a504-720f707f497a">
</div>
...
---
>🛠️ Matplotlib는 파이썬에서 데이터를 시각화하기 위한 가장 널리 사용되는 라이브러리 중 하나입니다.  
>이를 통해 그래프, 차트, 히스토그램 등을 손쉽게 생성할 수 있으며, 다양한 형식으로 데이터를 시각화할 수 있습니다.

>🛠️ Keras API는 딥러닝 모델을 간편하게 구축할 수 있는 고수준 API입니다.  
>Keras API는 원래 다양한 딥러닝 프레임워크에서 사용할 수 있는 고수준 API로 설계되었으며, TensorFlow, Theano, CNTK 등을 백엔드로 지원했습니다. 그러나 현재는 TensorFlow가 Keras의 주요 백엔드로 사용되고 있으며, 대부분의 딥러닝 작업에서는 `tf.keras`를 사용하는 것이 표준으로 자리 잡았습니다.
...
>>- `변수`는 텐서와 달리 학습 과정에서 값이 변경될 수 있는 객체입니다. 예를 들어, 가중치(weight)와 편향(bias) 같은 신경망의 파라미터들은 변수로 정의됩니다. 학습된 값은 모델에 저장되어 추후 예측 시 사용됩니다.
>>- `다양한 최적화 알고리즘(Optimizer)`을 제공하여 모델의 손실 함수를 최소화합니다. 대표적인 알고리즘으로는 경사 하강법(SGD), Adam Optimizer 등이 있습니다.
>>- 학습된 모델은 저장할 수 있으며 나중에 다시 불러와 예측에 사용할 수 있습니다.
>>   - 모델 저장: `model.save('my_model.h5')`
>>   - 모델 불러오기: `new_model = tf.keras.models.load_model('my_model.h5')`
